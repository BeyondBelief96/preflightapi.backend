...
public class SigmetControllerTests
{
    ...
    public async Task SearchAffecting_HappyPath_ReturnsSigmets()
    {
        ...
        var result = await _sut.SearchAffecting(32.8968m, -97.0380m, new PaginationParams { Limit = 100 });
    ...
    {
        var act = () => _sut.SearchAffecting(91m, -97.0380m);
    ...
    {
        var act = () => _sut.SearchAffecting(32.8968m, 181m);
    ...
    public async Task SearchByArea_HappyPath_ReturnsSigmets()
    {
        ...
        var result = await _sut.SearchByArea(30m, 35m, -100m, -95m, new PaginationParams { Limit = 100 });
    ...
    {
        var act = () => _sut.SearchByArea(35m, 30m, -100m, -95m);
    ...
    {
        var act = () => _sut.SearchByArea(30m, 35m, -95m, -100m);
    ...
    {
        var act = () => _sut.SearchByArea(-91m, 35m, -100m, -95m);
    ...
    {
        var act = () => _sut.SearchByArea(30m, 35m, -181m, -95m);
