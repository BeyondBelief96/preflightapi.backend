...
public interface INavaidService
{
    ...
    Task<PaginatedResponse<NavaidDto>> SearchNearby(decimal latitude, decimal longitude, double radiusNm, string? navType, string? cursor, int limit, CancellationToken ct = default);
}
