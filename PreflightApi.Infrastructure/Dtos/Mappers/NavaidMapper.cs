...
public static class NavaidMapper
{
    ...
    public static NavaidDto ToDto(Navaid navaid, ILogger logger)
    {
        ...
        return new NavaidDto
        {
            ...
            Latitude = (double?)navaid.LatDecimal,
            Longitude = (double?)navaid.LongDecimal,
            Elevation = (double?)navaid.Elev,
            MagneticVariation = navaid.MagVarn,
            MagneticVariationDirection = navaid.MagVarnHemis,
            MagneticVariationYear = navaid.MagVarnYear,
            Frequency = (double?)navaid.Freq,
            Channel = navaid.Chan,
            ...
            TacanDmeLatitude = (double?)navaid.TacanDmeLatDecimal,
            TacanDmeLongitude = (double?)navaid.TacanDmeLongDecimal,
