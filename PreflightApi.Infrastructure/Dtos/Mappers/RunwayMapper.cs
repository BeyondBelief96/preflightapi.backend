...
public static class RunwayMapper
{
    ...
    public static RunwayEndDto ToDto(RunwayEnd runwayEnd, ILogger logger)
    {
        ...
        return new RunwayEndDto
        {
            ...
            Latitude = (double?)runwayEnd.LatDecimal,
            Longitude = (double?)runwayEnd.LongDecimal,
            Elevation = (double?)runwayEnd.Elevation,
            ThresholdCrossingHeight = (double?)runwayEnd.ThresholdCrossingHeight,
            VisualGlidePathAngle = (double?)runwayEnd.VisualGlidePathAngle,
            DisplacedThresholdLatitude = (double?)runwayEnd.DisplacedThresholdLatDecimal,
            DisplacedThresholdLongitude = (double?)runwayEnd.DisplacedThresholdLongDecimal,
            DisplacedThresholdElevation = (double?)runwayEnd.DisplacedThresholdElev,
            DisplacedThresholdLength = runwayEnd.DisplacedThresholdLength,
            TouchdownZoneElevation = (double?)runwayEnd.TouchdownZoneElev,
            ...
            DisplacedThrLatSec = (double?)runwayEnd.DisplacedThrLatSec,
            ...
            DisplacedThrLongSec = (double?)runwayEnd.DisplacedThrLongSec,
            ...
            RunwayGradient = (double?)runwayEnd.RunwayGradient,
            ...
            LahsoLatDecimal = (double?)runwayEnd.LahsoLatDecimal,
            LahsoLongitude = runwayEnd.LahsoLongitude,
            LahsoLongDecimal = (double?)runwayEnd.LahsoLongDecimal,
